...
#' @param par a vector with name {chl, a_g_440, a_nap_440, bb_p_550}, Optionally, provide manual for (and/or) a_g, a_nap, bb_p slope with names {a_g_s_g, a_g_s_d, a_nap_s, bb_p_gamma}.
